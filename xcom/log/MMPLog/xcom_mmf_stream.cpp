...
namespace xcom
{
    ...
    mmf_ostream::mmf_ostream(char const* pathname,
        xcom::mmf_exists_mode exists_mode,
        xcom::mmf_doesnt_exist_mode doesnt_exist_mode)
    {
        open(pathname, exists_mode, doesnt_exist_mode);
    }

    void mmf_ostream::open(char const* pathname,
        xcom::mmf_exists_mode exists_mode,
        xcom::mmf_doesnt_exist_mode doesnt_exist_mode)
    {
        if (! pathname) return;
